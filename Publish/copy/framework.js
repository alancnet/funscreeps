        ...
        Runtime:
        {
                    ...
                    function define(a, b) {
                        for (var k in b) {
                            ...
                            if (t1 == "object" && t2 == "object") {
                                ...
                                //throw new Global.Error("Name conflict: " + k + ', ' + t1);
                            }
                        }
                    }
                    define(a, b);
            ...
            UnionByType:
                function (types, value, optional) {
                    ...
                    if (!optional) {
                        throw new Global.Error("Type not expected for creating Choice value.");
                    }
                }
        }
    };

    this.IntelliFactory = IntelliFactory;


    {
        if (!this) throw 'this is undefined';
            ...
            WebSharper: {
                ...
                Arrays: {
                    ...
                    checkBounds2D: function (arr, n1, n2) {
                        return (((n1 < 0 ? true : n2 < 0) ? true : n1 >= arr.length) ? true : n2 >= (arr.length ? arr[0].length : 0)) ? Operators.Raise(new Global.Error("IndexOutOfRangeException")) : null;
                    },
                            ...
                            creg = function () {
                                return Concurrency.Register(c.ct, function () {
                                    ...
                                    action = function () {
                                        return c.k.call(null, {
                                            $: 2,
                                            $0: new Global.Error("OperationCanceledException")
                                        });
                                    };
                                    return Concurrency.scheduler().Fork(action);
                                });
                ...
                Operators: {
                    ...
                    FailWith: function (msg) {
                        return Operators.Raise(new Global.Error(msg));
                    },
                                    ...
                                    callback = function (tupledArg) {
                                        ...
                                        callback1 = function () {
                                            ...
                                            if (waiting.contents) {
                                                ...
                                                _ = cc(new Global.Error("OperationCanceledException"));
                                            }
                                            else {
                                                _ = null;
                                            }
